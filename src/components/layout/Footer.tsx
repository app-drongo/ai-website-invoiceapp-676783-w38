...
const DEFAULT_FOOTER = {
  ...
  companyDescription:
    'Streamline your invoicing process with our modern, efficient platform. Trusted by thousands of businesses to manage their billing and payments seamlessly.',
  contactEmail: 'hello@invoiceflow.com',
  contactPhone: '+1 (555) 123-4567',
  contactAddress: '123 Tech Hub, Suite 100, San Francisco, CA',
  newsletterTitle: 'Stay Updated',
  newsletterPlaceholder: 'Enter your email',
  newsletterDisclaimer: 'Get the latest updates and features. No spam, unsubscribe anytime.',
  section1Title: 'Product',
  section2Title: 'Company',
  section3Title: 'Resources',
  section4Title: 'Legal',
  copyrightText: '© 2024 InvoiceFlow. All rights reserved.',
  madeWithText: 'with ❤️ by InvoiceFlow team',
  ...
  linkFeaturesHref: '#hero',
  linkPricing: 'Pricing',
  linkPricingHref: '#hero',
  linkTemplates: 'Templates',
  linkTemplatesHref: '#hero',
  linkIntegrations: 'Integrations',
  linkIntegrationsHref: '#hero',
  linkApi: 'API',
  linkApiHref: '#hero',
  linkDocumentation: 'Documentation',
  linkDocumentationHref: '#hero',
  // Company Links
  linkAbout: 'About Us',
  linkAboutHref: '#hero',
  linkBlog: 'Blog',
  linkBlogHref: '#hero',
  linkCareers: 'Careers',
  linkCareersHref: '#contact',
  linkPress: 'Press',
  linkPressHref: '#contact',
  linkPartners: 'Partners',
  linkPartnersHref: '#contact',
  linkContact: 'Contact',
  linkContactHref: '#contact',
  // Resources Links
  linkHelp: 'Help Center',
  linkHelpHref: '#contact',
  linkCommunity: 'Community',
  linkCommunityHref: '#contact',
  linkTutorials: 'Tutorials',
  linkTutorialsHref: '#hero',
  linkWebinars: 'Webinars',
  linkWebinarsHref: '#hero',
  linkCaseStudies: 'Case Studies',
  linkCaseStudiesHref: '#hero',
  linkStatus: 'Status',
  linkStatusHref: '#hero',
  // Legal Links
