...
const DEFAULT_HERO = {
  badge: 'Trusted by 5,000+ businesses worldwide',
  title: 'Streamline your invoicing',
  titleHighlight: 'effortlessly',
  subtitle:
    'The complete invoicing platform for modern businesses. Create, send, and track professional invoices in minutes, not hours.',
  primaryCTA: 'Start Free Trial',
  secondaryCTA: 'View Demo',
  primaryCTAHref: '/signup',
  secondaryCTAHref: '/demo',
  feature1Icon: 'zap',
  feature1Text: 'Instant invoicing',
  feature2Icon: 'shield',
  feature2Text: 'Bank-level security',
  feature3Icon: 'globe',
  feature3Text: 'Multi-currency support',
  trustedByText: 'Trusted by businesses of all sizes',
