...
const DEFAULT_CONTACT = {
  badge: 'Get in Touch',
  mainTitle: 'Ready to Streamline',
  mainTitleHighlight: 'Your Invoicing?',
  mainDescription:
    "Have questions about our invoicing platform? We'd love to help you get started. Send us a message and we'll respond within 24 hours.",
  formTitle: 'Contact Our Team',
  formDescription:
    "Tell us about your invoicing needs and we'll show you how our platform can help.",
  submitButton: 'Send Message',
  contactSectionTitle: 'Reach Out',
  method1Title: 'Email Support',
  method1Description: 'Get help via email',
  method1Contact: 'support@invoiceflow.com',
  method2Title: 'Sales Team',
  method2Description: 'Speak with our sales team',
  method2Contact: '+1 (555) 123-4567',
  method3Title: 'Live Chat',
  method3Description: 'Chat with our team',
  method3Contact: 'Available 9 AM - 6 PM EST',
  officesSectionTitle: 'Our Locations',
  office1City: 'San Francisco',
  office1Address: '123 Tech Street, Suite 200',
  office1Timezone: 'PST (UTC-8)',
  office2City: 'New York',
  office2Address: '456 Business Ave, Floor 12',
  office2Timezone: 'EST (UTC-5)',
  office3City: 'Austin',
  office3Address: '789 Innovation Blvd, Building C',
  ...
  messagePlaceholder: 'Tell us about your invoicing challenges or questions about our platform...',
} as const;
          ...
          <Card className="border-border/50">
            ...
            <CardContent>
              ...
              <form
                ...
                className="space-y-6"
                data-form-id="FORM_ID_PLACEHOLDER"
              >
